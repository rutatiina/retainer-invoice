...
use Rutatiina\RetainerInvoice\Traits\InventoryReverse as TxnTraitsInventoryReverse;
...
class Update
{
    ...
    public function run()
    {
        ...
        $Txn = RetainerInvoice::with('items', 'ledgers', 'debit_account', 'credit_account')->find($this->txn['id']);
        ...
        try
        {
            ...
            {
                $item['retainer_invoice_id'] = $txnId;
            ...
            {
                $ledger['retainer_invoice_id'] = $txnId;
