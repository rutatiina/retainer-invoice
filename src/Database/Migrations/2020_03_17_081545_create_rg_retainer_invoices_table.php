...
class CreateRgRetainerInvoicesTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::connection('tenant')->create('rg_retainer_invoices', function (Blueprint $table) {
    ...
    {
        Schema::connection('tenant')->dropIfExists('rg_retainer_invoices');
    }
}
