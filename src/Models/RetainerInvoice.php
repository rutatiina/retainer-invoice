...
class RetainerInvoice extends Model
{
    ...
    protected $table = 'rg_retainer_invoices';
    ...
    {
        return $this->hasMany('Rutatiina\RetainerInvoice\Models\RetainerInvoiceComment', 'retainer_invoice_id')->latest();
    }
    ...
    {
        return $this->hasMany('Rutatiina\RetainerInvoice\Models\RetainerInvoiceItemTax', 'retainer_invoice_id', 'id');
    }
